...
export default function Search() {
    ...
    const MemoOnKeydown = React.useCallback<(e: KeyboardEvent) => void>(onKeydown, [
        selected,
        visible,
    ]);

    useEvent('keydown', (e: Event) => MemoOnKeydown(e as KeyboardEvent), globalThis);
    React.useEffect(() => setSelected(-1), [visible]);
