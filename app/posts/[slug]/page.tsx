...
import { CodeSnippet } from '@/_comps/code-snippet';
import { mdx } from '@/_comps/mdx';
import { APP_URL } from '@/_consts';
import { reqList, reqPost } from '@/_helpers/posts';
...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
    ...
    return {
        title,
        description: ogTitle,
        alternates: { canonical: new URL(`/posts/${slug}`, APP_URL).toString() },
        openGraph: {
            determiner: '',
            title: ogTitle,
            description: ogDes,
